...
public class CopyOfSAXCardsActivityHandler extends DefaultHandler {
	List<CardSet> allCardSets = new ArrayList<CardSet>();
	List<CopyOfCard> allCards = new ArrayList<CopyOfCard>();
	CopyOfCard c;
	CardSet cs;
	...
	String[] picURL = {}, color = {};
	CardSet[] cardSets = {};
	HashMap<CardSet, URL> hmSetImages;
	...
	public List<CopyOfCard> getAllCards() {
		return allCards;
	}
	...
	public void endElement(String uri, String localName, String qName)
		...
		if (isSet) {
			...
			if (localName.equals("name")) {
				...
				c = new CopyOfCard(name, cardSets, picURL, color, manaCost, type, pt, text);
				allCards.add(c);
